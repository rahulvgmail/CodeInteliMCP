"""Test only graph service without vector service."""
...
async def test_graph_only():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        logger.info(f"=== Graph-Only Integration Test ===")
        ...
        # Create DI container manually with just graph and parser
        ...
        logger.info("\nGraph-only integration test completed successfully!")


async def main():
    """Run the test."""
    try:
        await test_graph_only()
